...
/****************************STYLES*********************************/
func control_style(w http.ResponseWriter, r *http.Request) {
  ...
  renderControl(w, r, "control/control_style.html", data, dbData)
...
//FUNC CONTROL PAGES
func control_style_edit(w http.ResponseWriter, r *http.Request) {
...
//FUNC CONTROL PAGES
func control_style_delete(w http.ResponseWriter, r *http.Request) {
